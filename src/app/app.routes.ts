...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./shared/layout/nav-bar/nav-bar.component').then(m => m.NavBarComponent),
    children: [
      {
        path: '',
        pathMatch: 'full',
      ...
      },
      {
        ...
        loadComponent: () => import('./features/platoform-tenant/platoform-tenant').then(m => m.PlatoformTenant)
      },
      {
        path: 'tenant/users',
